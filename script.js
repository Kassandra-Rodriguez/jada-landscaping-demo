/* ═══════════════════════════════════════════════════════
   JADA Landscaping & Construction — concept site behaviour
   ═══════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  /* ─── Financing assumptions ───────────────────────────
     ...
     JADA's lender / finance partner before this goes live.
     ─────────────────────────────────────────────────── */
  var APR = 0.0999;           // 9.99% annual percentage rate
  // terms offered live in the markup (36 / 60 / 120 months)
  ...
  function applyLang(lang) {
    ...
    try { localStorage.setItem('jada-lang', lang); } catch (e) {}
